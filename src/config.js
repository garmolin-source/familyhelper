...
const GROUP_CHILD_MAP = [
  { keywords: ['כיתה א', 'מהמורה', 'מעגלי צהריים', 'כדורגל', 'ג׳ודו'], child: 'כרמי', age: 7, grade: 'כיתה א׳', gender: 'male' },
  { keywords: ['גן רון', 'צהרון רון', 'תנועה יצירתית'], child: 'ארז', age: 4.5, grade: 'גן חובה', gender: 'female' },
